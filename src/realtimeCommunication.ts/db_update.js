...
var database = function (io) {
    ...
    db.once("open", function () {
        ...
        changeStream.on("change", function (change) { return __awaiter(void 0, void 0, void 0, function () {
            var allDocuments, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        console.error("Error fetching documents after change:", err_1);
                        return [3 /*break*/, 3];
